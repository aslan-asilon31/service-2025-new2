...
Route::middleware('admin')->prefix('admin')->group(function () {
    ...
    Route::get('/barang', \App\Livewire\MsBarangResources\MsBarangList::class)->name('barang.list');
    // Route::get('/barang/create', \App\Livewire\MsBarangResources\BarangCrud::class)->name('barang.create');
    ...
    Route::get('/cabang/create', \App\Livewire\MsCabangResources\CabangCrud::class)->name('cabang.create');
    ...
    Route::get('/pegawai/buat', \App\Livewire\MsPegawaiResources\PegawaiCrud::class)->name('pegawai.buat');
    Route::get('/pegawai/edit/{id}', \App\Livewire\MsPegawaiResources\PegawaiCrud::class)->name('pegawai.ubah');
    Route::get('/pegawai/show/{id}', \App\Livewire\MsPegawaiResources\PegawaiCrud::class)->name('pegawai.tampil');
