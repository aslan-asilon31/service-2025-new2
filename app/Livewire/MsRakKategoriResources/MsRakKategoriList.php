...
class MsRakKategoriList extends Component
{

  public string $title = "Rak Kategori";
  public string $url = "/rak-kategori";
  ...
  public function mount()
  {
    ...
    // dd($user->hasPermissionTo('cabang-list', 'admin'));
  }
  ...
  {
    $masterData = MsRakKategori::findOrFail($this->id);
  ...
  {
    return view('livewire.rak-resources.rak-list')
      ->title($this->title);
  }
}
