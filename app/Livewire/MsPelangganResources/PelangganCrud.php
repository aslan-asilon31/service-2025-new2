...
use App\Models\PelangganCategoryFirst;
...
class PelangganCrud extends Component
{
  ...
  {
    return view('livewire.pelanggan-resources.pelanggan-crud')
      ->title($this->title);
  }
  ...
  #[\Livewire\Attributes\Locked]
  protected $masterModel = \App\Models\MsPelanggan::class;

  public PelangganForm $masterForm;
