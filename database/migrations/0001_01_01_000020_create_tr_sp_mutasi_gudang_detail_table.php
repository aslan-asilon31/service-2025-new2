...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('tr_sp_mutasi_gudang_detail', function (Blueprint $table) {
            ...
            $table->uuid('tr_sp_mutasi_gudang_header_id');
            $table->foreign('tr_sp_mutasi_gudang_header_id', 'fk_tr_sp_mutasi_gudang_header_id')->references('id')->on('tr_sp_mutasi_gudang_header')->onDelete('cascade')->onUpdate('cascade');
