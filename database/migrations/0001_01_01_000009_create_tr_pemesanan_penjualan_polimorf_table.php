...
return new class extends Migration
{
    ...
    {
        Schema::create('tr_pemesanan_penjualan_polimorf', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->uuid('tr_pemesanan_penjualan_polimorf_id');
            $table->string('tr_pemesanan_penjualan_polimorf_tipe');
