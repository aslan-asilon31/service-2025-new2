...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('tr_sp_simpan_rak_detail', function (Blueprint $table) {
            ...
            $table->uuid('tr_sp_simpan_rak_detail_id');
            $table->foreign('tr_sp_simpan_rak_detail_id', 'fk_tr_sp_simpan_rak_detail')->references('id')->on('tr_sp_simpan_rak_header')->onDelete('cascade')->onUpdate('cascade');
